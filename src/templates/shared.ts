...
/** Story canvas dimensions and safe zones */
export const FEED_HEIGHT  = 675
export const STORY_HEIGHT = 960
export const STORY_SAFE_TOP    = 120  // avoid Instagram UI
export const STORY_SAFE_BOTTOM = 180  // avoid ads button
