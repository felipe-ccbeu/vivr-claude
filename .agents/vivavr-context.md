...
"It's time to finally live and learn a new language in a fun way, and immerse yourself in real life situations with our amazing scenarios. Join us with the latest AR game-based experience for language learning and reach fluency in an easy way. Learning a new language should be fun. And now it is."

## Core promise
Live and learn — immerse yourself in real-life situations, not isolated exercises.

## Category
Language-learning mobile app. AR + game-based mechanics. iOS first.

## Pricing
- Free tier available
- VIVR Premium Access: R$29.90/month (auto-renewing subscription via iTunes)
...
### Typography
- **Primary font: Nunito** — rounded, friendly, modern. Used in all UI text and marketing materials.
...
### Audience 1
Adults who studied English before but still freeze in real conversations.

### Audience 2
People preparing for travel who want practical confidence using the language.

### Audience 3
Users tired of repetitive language-learning apps looking for something more dynamic, visual, and immersive.

### Audience 4
Young adults and adults who respond well to game mechanics and want learning to feel like entertainment, not homework.

---

## Main pain points
- I studied before, but I still cannot use the language naturally.
- Traditional apps feel repetitive and disconnected from real life.
- I lose motivation because learning feels abstract and boring.
- I want practical confidence, not just theory.
- I want to feel inside the language, not just answering exercises.
- I start apps and abandon them after a few days.

## Product differentiators
- AR game-based experience — unique in the language learning category
- Real-life scenario immersion (kitchen, café, everyday situations)
- 3D animated characters that feel alive and engaging
- Game mechanics: choices, feedback, progression
- Fun-first approach without sacrificing real learning
- Mobile-first, designed for short daily sessions
- Premium feel with accessible free tier

## Emotional outcomes
- Confidence
- Practical readiness
- Fun and motivation to come back daily
- Engagement that doesn't feel like studying
- Feeling capable in real situations
- Pride in actual progress

---

## Messaging principles
- Show the gap between studying and actually using the language.
- Emphasize the "live it" experience — you're inside the scenario, not reading about it.
- Make the product feel alive, playful, and experiential.
- Use language that feels concrete, not academic.
...
- You do not need more theory. You need better practice.
- Finally, an app that makes you want to come back tomorrow.
- What if learning English felt like a game you actually wanted to play?

## Things to avoid
- Empty claims like "learn fluently fast"
- Generic "best app" language
- Overly technical explanations
- Copy that sounds like every other EdTech brand
- Weak visual concepts with no emotional tension
- Ignoring the fun/game angle — it is a core differentiator
- Making it sound like a kids' app (the audience is adults)
